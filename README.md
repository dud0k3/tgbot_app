...
* выбор даты получения заказа;
* применение промокодов;
* оформление заказа внутри Telegram;
* получение уведомления о статусе заказа;
* участие в реферальной программе.

### Для администратора

* создание и редактирование категорий;
* добавление товаров с фотографией или без неё;
* изменение названия, описания и цены;
